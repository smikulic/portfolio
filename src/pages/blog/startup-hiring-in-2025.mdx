...
title: "Startup Hiring in 2025: A Follow-Up to ‘From Silicon Allee to Silicon Valley"
description: "Six years ago, I wrote a blog post about moving from Croatia to Berlin and later navigating Silicon Valley hiring. At the time, I was struck by how different the two worlds felt."
date: "2025-08-26"
...
Six years later, I’m revisiting those thoughts to reflect on what has changed in startup hiring — and what hasn’t.
...
If we agreed on the best kebab in the city and I could help them with their next milestone, we ended up working together. Inverting a binary tree from memory didn't matter as much.
...
In the past six years, I’ve had the chance to work with startups in Berlin, San Francisco, and across Europe and the US. I've worked as a remote contractor, consultant, team lead, and engineer, and the hiring patterns have been clear.

**Europe has matured.** Interviews are more structured, processes more formal, and HR often steps in earlier. But compared to the US, hiring is still more pragmatic and product-focused. [Industry observers also note this](https://newsletter.pragmaticengineer.com/p/the-reality-of-tech-interviews?utm_source=chatgpt.com).

**In the US, especially post-remote shift, filtering has gotten stricter**. Many companies lean harder on technical challenges because they need to “screen at scale.” The result is more hoops for candidates to jump through and less attention on whether someone can actually help ship the product.

**Founder takeaway:** Early hires are about trust and impact. Formal processes help, but don’t let filters prevent you from recognizing the builders who thrive in ambiguity.
...
That irony feels even stronger today. The toughest, most abstract screenings still don’t guarantee great hires and now AI has made the problem bigger.
Today, AI can solve most algorithm challenges better than humans. Which means your AI-generated screening test may just be competing against a candidate’s AI-generated solution. That’s a game with no winners, and one that hiring experts warn can [depersonalize the process](https://time.com/7306955/ai-job-interview-recruitment/?utm_source=chatgpt.com).
...
What AI can’t do is show product intuition, empathy for users and your team, or the ability to move fast and communicate when things are messy and unclear.

**Founder takeaway:** Go back to basics: talk to people, lean on your network, and make referrals part of your process.
...
- **Algorithms prove intelligence, but not product sense.**
...
After a decade of building products across Europe and the US, this continues to guide me: whether I’m leading a frontend effort or advising a founder, I focus less on abstract tests and more on the only question that matters — *how can we ship something valuable, fast?*