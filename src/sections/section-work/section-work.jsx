    ...
    <div id="work" className="section section-work">
      ...
      <div className="project">
        ...
        >
          <picture>
            <source
              srcSet={creditKarmaProjectImg.src}
              type="image/webp"
              alt="Credit Karma"
            />
            <img src={creditKarmaProjectImgJpg.src} alt="Credit Karma" />
          </picture>
        </a>
        <div className="project-description">
          ...
          <div>
            <a href="/credit-karma-case-study">
      ...
      <div className="project">
        ...
        >
          <picture>
            <source
              srcSet={gleanProjectImg.src}
              type="image/webp"
              alt="Glean"
            />
            <img src={gleanProjectImgJpg.src} alt="Glean" />
          </picture>
        </a>
        <div className="project-description">
          <h3>Glean</h3>
      ...
      <div className="project">
        ...
        >
          <picture>
            <source
              srcSet={solarisbankProjectImg.src}
              type="image/webp"
              alt="solarisBank"
            />
            <img src={solarisbankProjectImgJpg.src} alt="solarisBank" />
          </picture>
        </a>
        <div className="project-description">
          <h3>solarisBank</h3>
      ...
      <div className="project">
        ...
        >
          <picture>
            <source
              srcSet={movieoProjectImg.src}
              type="image/webp"
              alt="Movieo"
            />
            <img src={movieoProjectImgJpg.src} alt="Movieo" />
          </picture>
        </a>
        <div className="project-description">
          <h3>Movieo</h3>
