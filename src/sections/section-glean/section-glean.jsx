      ...
      <p>
        ...
        <div className="section-img-two-column">
          <div className="section-img">
            <picture className="section-img-center">
              <source
                srcSet={gleanPaymentOneImg.src}
                type="image/webp"
                alt="Glean Payment"
              />
              <img src={gleanPaymentOneImgJpg.src} alt="Glean Payment" />
            </picture>
          </div>
          <div className="section-img">
            <picture className="section-img-center">
              <source
                srcSet={gleanPaymentTwoImg.src}
                type="image/webp"
                alt="Glean Payment"
              />
              <img src={gleanPaymentTwoImgJpg.src} alt="Glean Payment" />
            </picture>
          </div>
        </div>
        ...
        <div className="section-img-two-column">
          <div className="section-img">
            <picture className="section-img-center">
              <source
                srcSet={gleanHomepageImg.src}
                type="image/webp"
                alt="Glean Homepage"
              />
              <img src={gleanHomepageImgJpg.src} alt="Glean Homepage" />
            </picture>
          </div>
          <div className="section-img">
            <picture className="section-img-center">
              <source
                srcSet={gleanCompareImg.src}
                type="image/webp"
                alt="Glean Compare"
              />
              <img src={gleanCompareImgJpg.src} alt="Glean Compare" />
            </picture>
          </div>
        </div>
